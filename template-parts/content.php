<article class="block--item">
    ...
    <div class="addon">
        <div class="meta">
            ...
            <p><?php the_author(); ?> on <?php the_time('F j, Y'); ?> <?php the_category(' '); ?><svg aria-label="已编辑" role="img" viewBox="0 0 20.1325 21.186" class="x1lliihq xffa9am x2lah0s x1jwls1v x1n2onr6 x17fnjtu x1gaogpn" style="--fill: currentColor; --height: 16px; --width: 16px;" width=16 height=16>
                    <title>已编辑</title>

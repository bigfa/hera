                    ...
                    <div class="comment-meta">
                        ...
                        <div class="comment--meta">
                            <div class="comment--author" itemprop="author"><?php echo get_comment_author_link(); ?>
                                ...
                                <div class="comment--time" itemprop="datePublished" datetime="<?php echo get_comment_date('c'); ?>"><?php echo human_time_diff(get_comment_time('U'), current_time('U')) .  __(' ago', 'Hera'); ?></div>
                            </div>
                        </div>
                    </div>
